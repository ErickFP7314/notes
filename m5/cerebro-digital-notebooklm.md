...
- [Obsidian: Tu Segundo Cerebro](./obsidian-intro.md) — fundamentos de vault, backlinks y notas atómicas
- [Ecosistema Técnico de Obsidian](./obsidian-ecosistema.md) — LLM Wiki, arquitectura de tres capas, VS Code nativo
- [El Segundo Cerebro Empresarial](./segundo-cerebro-empresarial.md) — cómo escalar este sistema al conocimiento operativo de una empresa
- [notebooklm-rag-google-labs.md](../m1/notebooklm-rag-google-labs.md) — NotebookLM como capa de síntesis de fuentes externas
- [gentleman-ai-engram.md](../m4/gentleman-ai-engram.md) — Engram como sistema de memoria persistente equivalente para agentes
