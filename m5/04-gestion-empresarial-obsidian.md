...
- [Obsidian: Tu Segundo Cerebro](./01-obsidian-intro.md) — fundamentos del sistema sobre el que escala la gestión de equipo
- [El Segundo Cerebro Empresarial](./05-segundo-cerebro-empresarial.md) — arquitectura completa para el conocimiento operativo de la empresa
- [02-integracion-terceros.md](../m3/02-integracion-terceros.md) — API de Trello y otras integraciones con herramientas de gestión externas
