...
- [Obsidian: Tu Segundo Cerebro](./obsidian-intro.md) — fundamentos de vault, backlinks, notas atómicas
- [Obsidian + Claude Code: El Cerebro que Aprende](./cerebro-digital-notebooklm.md) — cloud.md, brain dump, integración con Claude Code
- [Gestión Empresarial con Obsidian](./gestion-empresarial-obsidian.md) — cómo Obsidian escala para dirigir equipos
- [claude-code.md](../m2/claude-code.md) — Claude Code como motor de operaciones sobre la vault
