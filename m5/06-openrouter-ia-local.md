# [L06] OpenRouter e IA Local: Sin Límites de Presupuesto
...
- [04-ollama-modelos-locales.md](../m2/04-ollama-modelos-locales.md) — guía detallada de instalación, gestión y optimización de modelos locales con Ollama
- [02-ecosistema-agentes.md](../m2/02-ecosistema-agentes.md) — cómo integrar modelos de OpenRouter y Ollama en flujos de trabajo agénticos
- [05-suscripciones-precios.md](../m2/05-suscripciones-precios.md) — comparativa completa de costos entre Claude Pro, API de Anthropic, y alternativas
