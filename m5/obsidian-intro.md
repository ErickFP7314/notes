...
- [Obsidian + Claude Code: El Cerebro que Aprende](./cerebro-digital-notebooklm.md) — cómo conectar Claude Code a la vault para que el sistema aprenda contigo
- [Ecosistema Técnico de Obsidian](./obsidian-ecosistema.md) — Git, LLM Wiki, arquitectura VS Code nativa, y la verdad sobre el grafo visual
- [claude-code.md](../m2/claude-code.md) — Claude Code como motor de escritura y organización dentro de la vault
