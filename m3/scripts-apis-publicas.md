...
- [Integración con Servicios Externos](./integracion-terceros.md) — el siguiente paso: conectar scripts Python con GitHub, Trello, Linear y n8n
- [MCP: El Protocolo que Conecta la IA con el Mundo](./mcp-conceptos.md) — la capa de estandarización que unifica todas las integraciones
- [claude-code.md](../m2/claude-code.md) — fundamentos del agente y sistema de skills sobre el que se construye Skill Creator
