...
- [MCP: El Protocolo que Conecta la IA con el Mundo](./mcp-conceptos.md) — conceptos fundacionales: arquitectura, primitivos y transporte
- [n8n: Flujos Visuales con IA](./n8n-flujos.md) — n8n puede consumir MCPs remotos como nodos dentro de flujos visuales
- [startup-n8n-graphify.md](../m4/startup-n8n-graphify.md) — caso de startup que combina MCP y n8n en un producto real
