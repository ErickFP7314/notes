...
- [n8n: Flujos Visuales con IA](./05-n8n-flujos.md) — n8n como orchestrador del flujo completo del bot
- [MCP: El Protocolo que Conecta la IA con el Mundo](./03-mcp-conceptos.md) — alternativa a cargar archivos Markdown: MCP de filesystem para que el agente navegue la bóveda directamente
- [02-cerebro-digital-notebooklm.md](../m5/02-cerebro-digital-notebooklm.md) — construir un cerebro digital completo sobre los mismos principios del LLM Wiki
