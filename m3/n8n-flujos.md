...
- [Integración con Servicios Externos](./integracion-terceros.md) — el contexto de las integraciones manuales que n8n viene a simplificar
- [MCP Avanzado: FastMCP, Casos Reales y Monetización](./mcp-avanzado.md) — MCPs que n8n puede consumir como herramientas dentro de sus flujos
- [WhatsApp RAG Bot](./whatsapp-rag-bot.md) — n8n como orchestrador del bot de WhatsApp con base de conocimiento
- [startup-n8n-graphify.md](../m4/startup-n8n-graphify.md) — caso real de producto construido sobre n8n como infraestructura de automatización
