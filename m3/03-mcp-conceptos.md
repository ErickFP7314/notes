...
- [MCP Avanzado: FastMCP, Casos Reales y Monetización](./04-mcp-avanzado.md) — construir servidores MCP propios con Python y el patrón FastMCP
- [Integración con Servicios Externos](./02-integracion-terceros.md) — el nivel anterior: integraciones directas que MCP viene a reemplazar y estandarizar
- [Hooks y Arquitectura de Contexto](./07-hooks-arquitectura-contexto.md) — cómo el aislamiento de MCPs por workspace encaja en la gestión de contexto del agente
