...
- [Hooks y Arquitectura de Contexto](./07-hooks-arquitectura-contexto.md) — los mismos principios de control y seguridad aplicados a nivel de hooks dentro de una sesión
- [06-claude-code.md](../m2/06-claude-code.md) — el agente base sobre el que se construye OpenClaw y el sistema de autonomía
- [04-ollama-modelos-locales.md](../m2/04-ollama-modelos-locales.md) — alternativa para agentes autónomos con modelos locales: sin costo por token, sin datos en la nube
