...
- [Agente 24/7: VPS, Telegram y las 4 Capas de Seguridad](./agente-247-vps.md) — aplicación de estos principios en un agente autónomo en producción
- [claude-code.md](../m2/claude-code.md) — fundamentos del agente y el sistema de settings donde viven los hooks
- [sdd-harness-engineering.md](../m4/sdd-harness-engineering.md) — el harness de ingeniería que combina hooks, Builder+Validator y Context Priming en un sistema completo
