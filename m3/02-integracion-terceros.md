...
- [Scripts, APIs y Claude Routines](./01-scripts-apis-publicas.md) — el patrón Python base que se conecta con estas integraciones
- [MCP: El Protocolo que Conecta la IA con el Mundo](./03-mcp-conceptos.md) — la capa de estandarización que va un nivel por encima de las integraciones directas
- [n8n: Flujos Visuales con IA](./05-n8n-flujos.md) — profundización en n8n: más casos, anatomía del flujo, y flujos como código
