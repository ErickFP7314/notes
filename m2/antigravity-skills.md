...
- [Ecosistema de Agentes](./ecosistema-agentes.md) — contexto sobre los tipos de agentes y por qué Antigravity es el punto de entrada del curso
- [Ollama y Modelos Locales](./ollama-modelos-locales.md) — cómo conectar modelos locales gratuitos a Antigravity para tareas repetitivas
- [Suscripciones y Precios](./suscripciones-precios.md) — qué plan necesitas para usar Antigravity con Claude Pro
