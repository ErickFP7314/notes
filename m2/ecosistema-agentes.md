...
- [Antigravity: Instalación y Skills](./antigravity-skills.md) — el agente de entrada del curso, cómo instalarlo y configurarlo
- [Ollama y Modelos Locales](./ollama-modelos-locales.md) — capa de infraestructura para modelos locales que se conecta a cualquier agente
- [Claude Code](./claude-code.md) — el agente privativo de Anthropic en profundidad
- [OpenCode y Opciones Abiertas](./opencode-opciones.md) — el agente open source agnóstico de modelo
