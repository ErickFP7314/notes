# [L14] OpenCode y Opciones Abiertas: Libertad de Modelo y Paralelismo
...
- [Ecosistema de Agentes](./ecosistema-agentes.md) — mapa completo de herramientas donde OpenCode encaja como agente open source
- [Ollama y Modelos Locales](./ollama-modelos-locales.md) — OpenCode + Ollama es la combinación para trabajo local sin costos de API
- [Claude Code](./claude-code.md) — la alternativa privativa de Anthropic para comparar directamente
