...
- [Ecosistema de Agentes](./02-ecosistema-agentes.md) — tipos de agentes disponibles y cómo elegir entre ellos
- [Claude Code](./06-claude-code.md) — implementación concreta del bucle autónomo con Plan Mode y Agent View
- [M1: Contexto, Tokens y Tipos de IA](../m1/01-contexto-tokens-tipos-ia.md) — fundamentos del contexto y la ventana de tokens que explican el degradado
