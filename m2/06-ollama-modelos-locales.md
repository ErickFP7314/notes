# [L06] Ollama y Modelos Locales: IA sin Costo de Tokens
...
- [Antigravity: Instalación y Skills](./03-antigravity-skills.md) — cómo conectar Ollama a Antigravity para usar modelos locales en el agente
- [OpenCode y Opciones Abiertas](./07-opencode-opciones.md) — OpenCode también soporta Ollama como proveedor de modelos
- [M5: OpenRouter e IA Local](../m5/06-openrouter-ia-local.md) — capa alternativa para acceder a modelos open source sin gestionar Ollama localmente
