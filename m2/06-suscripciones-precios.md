# [L06] Suscripciones y Precios: Qué Compras con Cada Plan
...
- [Ecosistema de Agentes](./02-ecosistema-agentes.md) — qué agentes necesitan qué tipo de plan para funcionar
- [Claude Code](./06-claude-code.md) — cómo conectar Claude Code con Claude Pro para trabajo técnico completo
- [OpenCode y Opciones Abiertas](./07-opencode-opciones.md) — OpenCode es el cliente que mejor aprovecha OpenRouter como proveedor
