...
- [Frontend con IA: Stitch y Claude Design](./02-frontend-ia-stitch.md) — construcción de la capa de interfaz sobre esta arquitectura
- [Backend Automático y Git Worktrees](./03-backend-git-worktrees.md) — las 4 formas de implementar el backend descrito aquí
- [Pagos, Deploy y el Desarrollador Potenciado](./07-pagos-deploy-reflexion.md) — Stripe + deploy completo del producto
