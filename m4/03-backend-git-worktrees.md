...
- [Arquitectura Web: Los 5 Pilares](./01-arquitectura-web.md) — los conceptos que el backend implementa
- [Frontend con IA: Stitch y Claude Design](./02-frontend-ia-stitch.md) — la capa que consume las APIs del backend
- [SDD y Harness Engineering](./04-sdd-harness-engineering.md) — la metodología para construir este backend de forma estructurada
- [Claude Code: Fundamentos](../wiki/06-claude-code.md) — el agente que ejecuta el deploy y gestiona los worktrees
