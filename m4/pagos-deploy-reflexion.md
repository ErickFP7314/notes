...
- [Arquitectura Web: Los 5 Pilares](./arquitectura-web.md) — el backend donde Stripe se integra (Pilar 2: APIs)
- [Startup Completa con n8n y Graphify](./startup-n8n-graphify.md) — el producto completo que este módulo monetiza
