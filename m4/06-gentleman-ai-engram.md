# [L06] Orquestación Multi-Agente y Memoria Persistente con Engram
...
- [SDD y Harness Engineering](./04-sdd-harness-engineering.md) — la metodología que el orquestador ejecuta
- [Startup Completa con n8n y Graphify](./06-startup-n8n-graphify.md) — el orquestador en acción en un producto completo
- [NotebookLM, RAG y Google Labs](../wiki/07-notebooklm-rag-google-labs.md) — herramienta para validar specs antes de delegar
- [Segundo Cerebro Empresarial](../wiki/05-segundo-cerebro-empresarial.md) — cómo Engram se integra en el sistema de conocimiento del M5
