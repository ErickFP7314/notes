...
- [Arquitectura Web: Los 5 Pilares](./01-arquitectura-web.md) — el contexto de dónde encaja el frontend en el stack completo
- [Backend Automático y Git Worktrees](./03-backend-git-worktrees.md) — la capa que el frontend consulta
- [Claude Code: Fundamentos](../wiki/06-claude-code.md) — el agente que convierte el design.md en código real
