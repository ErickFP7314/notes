...
- [Backend Automático y Git Worktrees](./backend-git-worktrees.md) — donde SDD se aplica en la construcción del backend
- [Orquestación Multi-Agente y Engram](./gentleman-ai-engram.md) — el sistema que ejecuta el plan SDD con múltiples agentes
- [Claude Code: Fundamentos](../wiki/claude-code.md) — el agente que ejecuta las fases de SDD
- [Hooks y Arquitectura de Contexto](../wiki/hooks-arquitectura-contexto.md) — los Sensors del harness (hooks de validación)
