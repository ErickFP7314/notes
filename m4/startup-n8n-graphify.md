...
- [Arquitectura Web: Los 5 Pilares](./arquitectura-web.md) — los fundamentos de lo que la startup implementa
- [SDD y Harness Engineering](./sdd-harness-engineering.md) — la metodología que estructura el desarrollo de la startup
- [Orquestación Multi-Agente y Engram](./gentleman-ai-engram.md) — el orquestador que coordina los subagentes
- [Pagos, Deploy y el Desarrollador Potenciado](./pagos-deploy-reflexion.md) — el cierre económico del ciclo
- [N8n y Flujos de Automatización](../wiki/n8n-flujos.md) — profundización en workflows de n8n del M3
