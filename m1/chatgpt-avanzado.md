...
- [Contexto de Chat, Tokens y Tipos de IA](./contexto-tokens-tipos-ia.md) — por qué el consumo de tokens determina la calidad de las respuestas en chats largos
- [Panorama de Herramientas LLM](./panorama-herramientas-llm.md) — cómo encaja ChatGPT en el ecosistema completo y cuándo elegir otra herramienta
