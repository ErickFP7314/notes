...
- [ChatGPT Avanzado](./03-chatgpt-avanzado.md) — uso profesional de la plataforma más conocida del ecosistema
- [Google Gemini](./04-google-gemini.md) — la apuesta de Google por integrar IA en su ecosistema
- [Modelos Open Source](./05-modelos-open-source.md) — DeepSeek, Llama, Mistral y el caso para correr modelos localmente
- [Claude: Funcionalidades Clave](./06-claude-funcionalidades.md) — por qué Claude es la herramienta principal del curso
