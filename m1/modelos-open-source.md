...
- [Panorama de Herramientas LLM](./panorama-herramientas-llm.md) — dónde encajan DeepSeek, Kimi y los modelos abiertos en el mapa completo del ecosistema
- [ollama-modelos-locales.md](../wiki/ollama-modelos-locales.md) — M2: configuración práctica de Ollama para agentes y automatizaciones locales
