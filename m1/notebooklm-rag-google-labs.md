...
- [Google Gemini](./google-gemini.md) — la suite de herramientas de Google donde vive NotebookLM, incluyendo Imagen, Veo y el ecosistema Workspace
- [Claude: Funcionalidades Clave](./claude-funcionalidades.md) — los Artefactos de Claude son el contrapunto: generación y prototipado vs. la investigación anclada de NotebookLM
- [sdd-harness-engineering.md](../wiki/sdd-harness-engineering.md) — M4: cómo NotebookLM alimenta la base de conocimiento que usan los agentes en flujos de trabajo complejos
