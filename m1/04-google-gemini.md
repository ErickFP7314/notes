...
- [Panorama de Herramientas LLM](./02-panorama-herramientas-llm.md) — contexto de por qué Google juega en los dos tableros (propietario y open source)
- [NotebookLM y RAG — Google Labs](./07-notebooklm-rag-google-labs.md) — la herramienta del ecosistema Google para investigación con documentos propios, sin alucinaciones
