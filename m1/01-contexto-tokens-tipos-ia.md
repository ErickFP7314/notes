...
- [Panorama de Herramientas LLM](./02-panorama-herramientas-llm.md) — cómo aplica la lógica de tokens al elegir modelo según tarea
- [Claude: Funcionalidades Clave](./06-claude-funcionalidades.md) — los Proyectos y el caché de archivos son la respuesta práctica al problema de la ventana de contexto
