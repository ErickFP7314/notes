...
- [Panorama de Herramientas LLM](./02-panorama-herramientas-llm.md) — por qué Claude es la herramienta principal del curso frente a otras alternativas
- [Contexto de Chat, Tokens y Tipos de IA](./01-contexto-tokens-tipos-ia.md) — los Proyectos y el caché son la solución práctica al problema de la ventana de contexto
- [06-claude-code.md](../wiki/06-claude-code.md) — M2: Claude Code para programación con agentes directamente desde el terminal
